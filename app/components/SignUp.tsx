      ...
      <div className="w-[900px] bg-white rounded-2xl shadow-lg flex overflow-hidden">
        ...
        <div className="w-1/2 p-10">
          <div className="flex items-center justify-between mb-4">
            ...
            <a href="#" className="text-gray-500 text-sm hover:underline">Go back</a>
          </div>
          <h2 className="text-2xl font-bold mb-2">Create account</h2>
          <p className="text-gray-500 mb-6">Start your 30-day free trial. Cancel anytime.</p>
          ...
          <div className="mb-4">
            ...
            <div className="mb-6">
              ...
              <input type="password" placeholder="Create a password" className="w-full p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" />
            </div>
        ...
        <div className="w-1/2 bg-gray-900 text-white flex items-center justify-center p-8 relative">
          <Image src="/images/car_image.webp" alt="User Testimonial" width={500} height={500} className="rounded-lg shadow-md" />
          
          <div className="absolute bottom-8 left-8 bg-white text-gray-900 p-4 rounded-lg shadow-lg w-[80%]">
            <p className="text-sm italic">
              "With Untitled, your support process can be as enjoyable as your product. When it’s this easy, customers keep coming back."
            </p>
            <p className="mt-3 font-bold">Jewel Rana</p>
            <p className="text-xs text-gray-600">Web Designer, Capsule<br />Web Development Agency</p>
          </div>
        </div>
      </div>
    </div>
