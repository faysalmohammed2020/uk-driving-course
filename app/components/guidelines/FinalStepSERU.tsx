      ...
      <div className="bg-white px-10 py-20 rounded-2xl shadow-lg max-w-7xl w-full grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="p-6 text-left">
          ...
          <p className="text-gray-700 mb-4">
            We will complete all necessary application forms and file your
            application directly to TFL. We ensure everything is done properly,
            making the process hassle-free and simple.
          </p>
          <h3 className="text-xl font-semibold text-teal-700 mb-2">
            Step-by-Step Final Process
          </h3>

          <div className="mb-4">
            <h4 className="text-lg font-semibold text-gray-800 flex items-center">
              <FaFileSignature className="mr-2 text-teal-700" /> Step 1:
              Completing Application Forms
            </h4>
            <p className="text-gray-600">
              Ensure all necessary application forms are accurately filled and
              signed.
            </p>
          </div>
          ...
          <div className="mb-4">
            <h4 className="text-lg font-semibold text-gray-800 flex items-center">
              <FaUserCheck className="mr-2 text-teal-700" /> Step 2: Identity
              Verification & Background Check
            </h4>
            <p className="text-gray-600">
              Your identity and background checks will be reviewed before
              submission.
            </p>
          </div>
          ...
          <div className="mb-4">
            <h4 className="text-lg font-semibold text-gray-800 flex items-center">
              <FaCheckCircle className="mr-2 text-teal-700" /> Step 3:
              Submitting the Application to TfL
            </h4>
            <p className="text-gray-600">
              We will submit your completed application to Transport for London
              (TfL) for approval.
            </p>
          </div>
        </div>
        ...
        <div className="p-6 border-l border-gray-200">
          ...
          {!isSubmitted ? (
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Your application process is now complete, and it's being
                reviewed by TfL.
              </p>
              <button
