        ...
        <div className="max-w-7xl mx-auto">
          ...
          <section className="text-center mb-12">
            ...
            <p className="text-lg mt-4 max-w-2xl mx-auto">
              Have questions about the PCO Licence process or need assistance? We’re here 24/7 to help you. Reach out to us via phone, email, or visit our office.
            </p>
          </section>
          ...
          <section className="grid md:grid-cols-2 gap-10 items-center">
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-semibold mb-4 text-orange-500">Contact Details</h3>
              <p className="mb-2"><strong>📞 Phone:</strong> 07576497335 / 02034884184</p>
              <p className="mb-2"><strong>📧 Email:</strong> info@londonpcoandtraining.co.uk</p>
              <p className="mb-2"><strong>📍 Address:</strong> Ashley House Business Centre, 235-239 High Rd, London N22 8HF, United Kingdom</p>
              <iframe
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <form className="space-y-4">
                ...
                <input type="tel" placeholder="Your Phone" className="w-full p-3 border rounded-lg" required />
