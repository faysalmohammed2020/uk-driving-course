  ...
  return (
    <div className="flex-1 overflow-auto">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-4">
        ...
        <div className="bg-white p-4 rounded shadow">
          <div className="flex justify-between items-center mb-4">
            <span className="text-sm text-gray-600">Scores created</span>
            <button className="text-gray-400">
              <HelpCircle className="w-4 h-4" />
            </button>
          </div>
        ...
        <div className="bg-white p-4 rounded shadow">
          <div className="flex justify-between items-center mb-4">
            <span className="text-sm text-gray-600">Assignment success</span>
            <button className="text-gray-400">
              <HelpCircle className="w-4 h-4" />
            </button>
          </div>
          ...
          <div className="flex justify-center">
            <div className="relative w-24 h-24">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                ...
                <span className="text-xs text-gray-500">Positive grades</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-4 rounded shadow">
          <div className="flex justify-between items-center mb-4">
            <span className="text-sm text-gray-600">Av. session</span>
            <button className="text-gray-400">
              <HelpCircle className="w-4 h-4" />
            </button>
          </div>
          ...
          <div className="flex items-baseline">
            <span className="text-3xl font-bold">{stats.avgSession.value}</span>
            <span className="text-sm text-gray-500 ml-1">
              {stats.avgSession.unit}
            </span>
          </div>
        </div>
        ...
        <div className="bg-white p-4 rounded shadow">
          ...
          <div className="flex items-baseline">
            <span className="text-3xl font-bold">
              {stats.assignmentsSubmitted.value}
            </span>
            <span className="text-xs text-green-500 ml-2">
              {stats.assignmentsSubmitted.change}
            </span>
          </div>
        </div>
      </div>
      ...
      <div className="p-4">
        <div className="mb-4 flex justify-between items-center">
          ...
          <div className="flex items-center space-x-2">
            ...
            <button className="text-sm text-blue-600 font-medium flex items-center px-3 py-2 border border-blue-600 rounded">
