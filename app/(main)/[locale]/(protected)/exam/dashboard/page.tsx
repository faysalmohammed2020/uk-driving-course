...
//   return (
//     <div>
//       <h2 className="text-3xl font-semibold mb-6 text-center mt-10 text-sky-800">
//         Your Exam Results
//       </h2>
//       <div className="overflow-x-auto shadow-lg rounded-lg border border-gray-300">
//         <table className="min-w-full table-auto text-gray-700">
//           <thead className="bg-gray-100 text-gray-600 text-lg font-semibold">
//             <tr>
...
//               <th className="py-3 px-6 text-left">Retake Exam</th> {/* New column */}
//             </tr>
//           </thead>
//           <tbody>
...
//                 <td className="py-4 px-6 border-b">{Math.round((result.score)/(result.total)*100)}%</td>
...
//                 </td>
//                 <td className="py-4 px-6 border-b">
//                   {result.status === "Failed" && ( // Only show the button if the exam is failed
//                     <button
//                       onClick={() => handleRetake(result.id)}
