    ...
    <div className="bg-gray-100">
            ...
            {steps.map((StepSection, index) => (
              ...
              >
                ...
                <div className="mt-4 text-white text-lg">
                  {/* Adding Link here */}
                  <Link href={StepSection.link}>
                    <span className="mt-4 text-lg hover:text-teal-400 transition duration-300">
                      Learn More
                    </span>
                  </Link>
                  →
      ...
      <section className="text-center py-12 bg-white">
        <h2 className="text-3xl font-semibold mb-4">
          {t("home.promiseSection.promiseTitle")}
        </h2>
            ...
            {courses.map((Courses, index) => (
              ...
              >
                ...
                <ul className="text-left mt-6 space-y-2">
                  ...
                  {Courses.features &&
                    Courses.features.map((feature, idx) => (
