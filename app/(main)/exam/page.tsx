...
export default function Exam() {
  ...
  return (
    <div className="min-h-screen p-10 bg-gray-100">
      {!hasStarted ? (
        // Guideline Section
        // <div className="bg-white p-10 rounded-2xl shadow-lg max-w-3xl mx-auto text-center border-t-4 border-blue-500">
        //   <h1 className="text-4xl font-extrabold mb-6 text-gray-800">
        //     Exam Guidelines
        //   </h1>
        //   <div className="mb-6">
        //     <img
        //       src="https://cdn-icons-png.flaticon.com/512/3159/3159063.png"
        //       alt="Guidelines"
        ...
        //     </p>
        //   </div>
        //   <ul className="text-left text-gray-700 list-disc list-inside space-y-2 mb-6 mx-10">
        //     <li className="flex items-start">
        //       <span className="material-icons text-blue-500 mr-2">timer</span>
        //       You will have <span className="font-semibold">30 minutes</span> to
        //       complete the exam.
        //     </li>
        //     <li className="flex items-start">
        ...
        //         check_circle
        //       </span>
        //       Each question has <span className="font-semibold">4 options</span>
        //       . Only one is correct.
        //     </li>
        //     <li className="flex items-start">
        ...
        //   <button
        //     onClick={startExam}
        //     className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-8 rounded-lg shadow-lg transition duration-300 transform hover:scale-105"
        //   >
        //     Start Exam
        //   </button>
        // </div>
